...
#### Scenario: Display renders each unit as a top-level bullet
- **WHEN** `print_army(army, race_config)` is called
- **THEN** each unit appears as a `- <unit name>` bullet point
