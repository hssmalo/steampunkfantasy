...
- [x] 1.5 Add `get_equipment(army_name)` function returning `dict[str, EquipmentConfig]` filtered by race
...
- [x] 2.5 Write tests for `get_equipment()` verifying race filtering and return type
