...
Defines the immutable data structures representing a player's assembled team: `TeamModel`, `TeamUnit`, and `Team`. These structures capture which models and equipment upgrades a player has chosen, layered on top of the static army configuration.
