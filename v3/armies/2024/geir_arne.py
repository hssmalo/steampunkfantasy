...
# x1 Tattoo Ink
army = (
    army.add_unit("tattoo_ink", race_config=cfg)
...
army = army.add_unit("armored_unicorn_rider", race_config=cfg).duplicate_unit(
    ("armored_unicorn_rider", 0)
)

# x1 Pegasus Rider
army = army.add_unit("pegasus_rider", race_config=cfg).duplicate_unit(
    ("pegasus_rider", 0)
)

# x1 Pachycephalosaurus Riders
army = army.add_unit("pachycephalosaurus_riders", race_config=cfg).duplicate_unit(
    ("pachycephalosaurus_riders", 0)
)
