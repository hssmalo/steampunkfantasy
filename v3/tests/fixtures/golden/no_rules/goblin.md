# Showcase Goblin — goblin — 576 points

*v1999.12.0*

## Elite Goblin Grenadier (4×)

- Size: Small
- Models: 4x Elite Goblin Infantry
- Type: Elite, Bio, Infantry, Walking
- Points: 48
- Shaken: slow [-, -, Flee] / Can't use weapons

- **To Hit**: Take Cover[Sneak][-2]
- **Fire Order**: You may either fire a regular arrow, a special arrow (arrow with limited ammo) or use one thrown weapon with each fire order.; For each fire order: fire a bow once (either a regular or special arrow) and in addition each regular infantry may use one thrown weapon while elite infantry may use 2 thrown weapons (or the same twice)
- **Evasion**: [4+]
...
- Equipment: 1x Goblin Grenade, 1x Grenadier, 1x Acid Grenade, 1x Gear Bow
- Assault: strength 2/1/1/1 (6+), deflection 4/0/0/0 (6+), damage d4-2, AP 2

- **To Hit**: Thrown Weapons[2]; Thrown Weapons[1]
...
## Goblin Infantry with Poison Bow (2×)
...
- Equipment: 1x Goblin Grenade, 1x Poison Bow
