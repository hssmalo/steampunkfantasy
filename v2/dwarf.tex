...
\noindent May transport up to 2 unit of Infantry or one SteamPowerArmor. Has Deploy[range=2] which may be used with Deploy orders\\ 
May not transport any infantri with wheeled shieldwall\\ 


\ \\ {\bf movement } \\
flying fast [360°, F, F+Depoloy] \\
flying fast [F, F+Depoloy, 360°] \\
flying fast [F, 360°, F+Deploy] \\
flying fast [F+Depoloy, F, 360°] \\
flying fast [360°, F, F] \\
flying fast [F, F, 360°] \\
flying fast [F, 360°, F] \\
...
\ \\ {\bf crew } \\
4-5: All transported units gain Poison[4] and takes d6 psycic damage. Shaken transported units may not be deployed. Double initial crew damage if already shaken \\
6-7: As 4-5, shaken \\
...
\\ 
Assault Damage: replace d6-2 + d6 psycic damage
\\ 
...
{\bf Assault} \ \\
Assault Damage: replace d6 (+3 if penetrating all armor)
\\ 
