...
app.layout = html.Div(
    [
        ...
        dcc.Input(
            id="teamname", type="text", placeholder="Enter personalised team name."
        ),
        html.Button("Save Name", id="submit_name", n_clicks=0),
        dcc.Dropdown(
            options=[{"label": "Standar", "value": "24ip, 24mp, 24xp, 24cp"}],
            id="gametype",
            placeholder="Choose a game type",
        ),
        dcc.Dropdown(
            options=[
                {"label": "Dark Elf", "value": "darkelf"},
                {"label": "Ork", "value": "ork"},
            ],
            id="race",
        ...
        dcc.Dropdown(
            ...
            value="N.A",
            id="modelupgrade",
            placeholder="Upgrade a model if possible",
        ),
        dcc.Dropdown(
            options=[],
            value="N.A",
