...
If not using aim, area[4+] at point blank range and area[6+] at all units within normal and long range within one choosen direction. Avoids firing at hexes with friendly units\\ 
...
\section{ Dire Polar Bear Riders }

\begin{tabular}{ll}
  Name & Dire Polar Bear Riders \\
  Size & medium\\
  Cost & 2mp, 6cp, 8xp\\
  Models & 1 x Dire Polar Bear Riders\\
  Armor & [8, 6, 6, 6]\\
  Shaken & Speed set to slow. Movement order: [-,-,flee]. may not use fire orders\\
  Special: \\
\end{tabular}
...
\noindent Poison Resistance 3\\ 
Flame arrow fires every gunnrey phase independent of gattling gun. Always treated as loaded\\ 
...
\noindent
\begin{tabular}{ll}
Model name: &{\bf Dire Polar Bear Riders } \\
Equipment Limits: &[Independent:∞] \\
Type: &[Bio, Cavalry, Walks] \\
Replaces: &Nothing \\
Cost: & 0\\
\end{tabular}
\ \\
Equipment: 1 x GatlingGun, 1 x Elf Flame Arrow \\
\ \\
Assault: [9, 6, 3, 1] Die: 5+ Armor Penetration: 2 Damage: d6+2 \\
Assault Deflection: [2, 0, 0, 0] Die: 5+\\
\indent  
\ \\
...
Pre-assault retreat: 3+\\ 
Grants psychic resitance 1 to the other unit in this hex\\ 
...
\noindent
\begin{tabular}{ll}
Model name: &{\bf Elk Cavalry } \\
Equipment Limits: &[Independent:∞, Hands:2] \\
Type: &[Bio, Cavalry, Walks, Elk] \\
Replaces: &Nothing \\
Cost: & 0\\
\end{tabular}
\ \\
...
Starts battle with one aim token. (note that it is lost if you don't fire first round)\\ 
...
\end{tabular}
\ \\
Equipment: 1 x Sniper Rifle, 1 x Heavy Mortar, 1 x Towed Main Gun, 1 x ThunderRoar, 1 x Light Mortar \\
\ \\
...
Range: 8  Angle: [True, False, False, False] AP: 3 Damage: d6-2 \\
...
Range: 3  Angle: [True, True, False, False] AP: 5 Damage: d6 \\
...
Range: 3  Angle: [False, False, False, True] AP: 8 Damage: d6 (+3 if penetrating all armor) \\
...
Range: 5  Angle: [False, True, False, False] AP: n.a Damage: d6 psycic \\
May fire once to the right and once to the left each time you fire\\ 
...
Range: 5  Angle: [False, False, True, False] AP: 2 Damage: d6-2 \\
Area[5] on a hex within normal range\\ 
...
Focus Fire[aim]: roll 6 dice at same unit.\\ 
If not using aim, area[4+] at point blank range and area[6+] at all hexes within normal and long range and within all allowed angles, but avoids hexes with friendly units.\\ 
...
\indent Cunning Assault[1 for 3]\\ 
Always attacks weakest point of armor\\ 
...
Requiers: & [[Independent:1], [type:Elk]] \\
Cost: & Upgrade all models for: 2cp \\
\end{tabular}
...
\ \\
\begin{tabular}{ll}
name: & {\bf Elf Flame Arrow } \\
Requiers: & [[Hands:2], [type:Infantry, type:Cavalry, type:Crew]] \\
Cost: & Upgrade all models for: 8cp \\
\end{tabular}
...
Target any hex within normal range\\ 
Always loaded, used with Throw order\\ 
