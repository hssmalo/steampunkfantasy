...
Unit gain Psycic resistance 1 while elite is alive\\ 
...
Flies for a short period of time.\\ 
May assault land units while flying if you wish.
...
Special: \\
Take Cover[still][-2], \\
May use multiple ranged weapons without any penalties\\ 
...
\begin{tabular}{ll}
  ...
  Armor & [0, 0, 0, 0]\\
  Victory points & 2\\
  Shaken & Move set to slow, move orders: -, -, Flee\\
\end{tabular}
Special: \\
Forward Position[2]\\ 
